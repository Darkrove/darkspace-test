...
const folderUpload = ({ handleChange }) => {
    return (
        <div>
                ...
                <div className="relative group w-full h-[15rem] flex justify-center items-center">
                    ...
                    <div className="absolute top-0 right-0 bottom-0 left-0 w-full h-full m-auo flex items-center justify-center">
                        <div className="space-y-6 text-center">
                            ...
                            <p className="text-gray-700 text-lg">Drag and drop a file or <label htmlFor="dragOver" title="Upload a file" className="relative z-1 cursor-pointer text-violet-500 block">Upload folder or all code files</label> </p>
